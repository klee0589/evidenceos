  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 text-center">
        ...
        >
          <Button size="lg" onClick={onDemoClick} className="text-base px-8 h-12 font-semibold gap-2 group">
            Try Demo Endpoint
            <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-0.5" />
          </Button>
          <Button size="lg" variant="outline" onClick={onWaitlistClick} className="text-base px-8 h-12 font-semibold gap-2 border-border/60 hover:bg-secondary">
        ...
        >
          ...
          <div className="rounded-2xl overflow-hidden border border-border/50 shadow-2xl shadow-primary/5">
            <img
              src={heroImage}
              alt="EvidenceOS sandbox API dashboard"
